(define-library (surfage s126 hashtables)
  (import (scheme base) (surfage s128 comparators) (surfage s125 hash-tables))
  (export
  ...
  (begin
    ...
    ; R6RS-flavored naming layered on (surfage s125 hash-tables). Like that
