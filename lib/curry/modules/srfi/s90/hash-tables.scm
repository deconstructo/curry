(define-library (srfi s90 hash-tables)
  ; Both (srfi s69 hash-tables) and (scheme base) export a binding named
  ...
  ; unconditionally.
  (import (srfi s69 hash-tables) (except (scheme base) make-hash-table))
  (export make-table)
  (begin
