...
/* ---- Procedures: (curry posix) module (also covers SRFI 112/170,
 * which re-export these same bindings under the same names) ---- */
/* ṭēmum: "report" (reused from condition-message) for a stat-like info
 * record; bītum: "house" (reused from define-library/home-vicinity) for
 * a directory; amēlum: "person"/kimtum: "family, clan" for user/group. */
AKK_PR("file-info",                     "ṭēm-ṭuppim",                "𒄀𒆜")
AKK_PR("file-info?",                    "ṭēm-ṭuppim?",               "𒍪𒆜")
AKK_PR("file-info:device",              "ṭēm-ṭuppi-maškanim",        "𒋻𒃲")
AKK_PR("file-info:inode",               "ṭēm-ṭuppi-zikrim",          "𒃲𒇲𒀭")
AKK_PR("file-info:mode",                "ṭēm-ṭuppi-gattim",          "𒀸𒊻")
AKK_PR("file-info:nlinks",              "ṭēm-ṭuppi-riksī",           "𒇲𒇽")
AKK_PR("file-info:uid",                 "ṭēm-ṭuppi-amēlim",          "𒀭𒈷𒊕")
AKK_PR("file-info:gid",                 "ṭēm-ṭuppi-kimtim",          "𒆠𒅁")
AKK_PR("file-info:rdev",                "ṭēm-ṭuppi-maškani-šanîm",   "𒈠𒂍")
AKK_PR("file-info:size",                "ṭēm-ṭuppi-mīnim",           "𒁹𒂍𒇽")
AKK_PR("file-info:blksize",             "ṭēm-ṭuppi-mīni-kīlim",      "𒆜𒋻𒂍")
AKK_PR("file-info:blocks",              "ṭēm-ṭuppi-kīlī",            "𒈧𒂍𒈧")
AKK_PR("file-info:atime",               "ṭēm-ṭuppi-adan-amārim",     "𒄀𒀀𒂗")
AKK_PR("file-info:mtime",               "ṭēm-ṭuppi-adan-šanêm",      "𒌋𒍪𒍪")
AKK_PR("file-info:ctime",               "ṭēm-ṭuppi-adan-banîm",      "𒋻𒃲𒁀")
AKK_PR("file-info-directory?",          "ṭēm-ṭuppi-bītum?",          "𒂗𒆠")
AKK_PR("file-info-regular?",            "ṭēm-ṭuppi-kayyamānum?",     "𒇲𒉡")
AKK_PR("file-info-symlink?",            "ṭēm-ṭuppi-mašli?",          "𒁹𒅆𒄿")
AKK_PR("file-info-fifo?",               "ṭēm-ṭuppi-nērebim?",        "𒄿𒍪𒊕")
AKK_PR("file-info-socket?",             "ṭēm-ṭuppi-bābim?",          "𒍪𒀸𒌑")
AKK_PR("file-info-device?",             "ṭēm-ṭuppi-unūtim?",         "𒇽𒀸𒌋")
AKK_PR("file-info-char-device?",        "ṭēm-ṭuppi-unūt-ṣibtim?",    "𒈷𒄿")
AKK_PR("create-directory",              "banû-bītim",                "𒄿𒅆𒅆")
AKK_PR("delete-directory",              "ḫepû-bītim",                "𒄀𒅆𒍪")
AKK_PR("directory-files",               "ṭuppū-bītim",               "𒍪𒂗𒌑")
AKK_PR("open-directory",                "petû-bītim",                "𒌝𒍪𒅁")
AKK_PR("read-directory",                "šemû-bītim",                "𒌝𒊻𒌑")
AKK_PR("close-directory",               "sakār-bītim",               "𒁀𒍪")
AKK_PR("rename-file",                   "šanî-šum-ṭuppim",           "𒀀𒈠𒈧")
AKK_PR("create-hard-link",              "banû-riksim",               "𒀀𒄀𒁹")
AKK_PR("create-symlink",                "banû-mašlim",               "𒆠𒊻𒅆")
AKK_PR("read-symlink",                  "šemû-mašlim",               "𒆠𒈠𒉡")
AKK_PR("real-path",                     "kīn-urḫim",                 "𒀀𒁀𒀭")
AKK_PR("truncate-file",                 "ḫarāṣ-ṭuppim",              "𒄿𒈷𒂗")
AKK_PR("set-file-mode",                 "šakān-gatti-ṭuppim",        "𒇲𒂗𒃲")
AKK_PR("set-file-owner",                "šakān-bēl-ṭuppim",          "𒌑𒇽𒇲")
AKK_PR("set-file-times",                "šakān-adan-ṭuppim",         "𒂗𒇽𒀀")
AKK_PR("umask",                         "maṣṣartu-ṭuppim",           "𒌑𒇽")
AKK_PR("set-umask!",                    "šakān-maṣṣarti-ṭuppim",     "𒊕𒁹")
AKK_PR("current-directory",             "bītu-inanna",               "𒈷𒀭")
AKK_PR("set-current-directory!",        "šakān-bīti-inanna",         "𒂍𒁹")
AKK_PR("pid",                           "zikru-napištim",            "𒅁𒌑𒉡")
AKK_PR("nice",                          "šutēšur-napištim",          "𒌑𒍪𒀸")
AKK_PR("user-uid",                      "amēl-kīnim",                "𒆜𒄿𒆜")
AKK_PR("user-gid",                      "amēl-kimtim",               "𒅆𒀸𒇲")
AKK_PR("user-effective-uid",            "amēl-epšētim",              "𒁀𒆜𒀭")
AKK_PR("user-effective-gid",            "amēl-kimti-epšētim",        "𒀀𒌝𒁹")
AKK_PR("user-supplementary-gids",       "kimtū-redîm",               "𒇽𒃲𒆜")
AKK_PR("user-info",                     "ṭēm-amēlim",                "𒀸𒉡𒅆")
AKK_PR("user-info?",                    "ṭēm-amēlim?",               "𒉡𒊻𒆠")
AKK_PR("user-info:name",                "ṭēm-amēli-šumim",           "𒄀𒂗𒀸")
AKK_PR("user-info:uid",                 "ṭēm-amēli-kīnim",           "𒃲𒄀")
AKK_PR("user-info:gid",                 "ṭēm-amēli-kimtim",          "𒊻𒀸𒄿")
AKK_PR("user-info:home-dir",            "ṭēm-amēli-bītim",           "𒊻𒀸")
AKK_PR("user-info:shell",               "ṭēm-amēli-qabîm",           "𒃲𒁀𒌝")
AKK_PR("user-info:full-name",           "ṭēm-amēli-šumi-gabbim",     "𒃲𒅆𒋻")
AKK_PR("group-info",                    "ṭēm-kimtim",                "𒈠𒄀𒊻")
AKK_PR("group-info?",                   "ṭēm-kimtim?",               "𒅆𒌝𒆠")
AKK_PR("group-info:name",               "ṭēm-kimti-šumim",           "𒌑𒆠𒋻")
AKK_PR("group-info:gid",                "ṭēm-kimti-kīnim",           "𒆜𒈷")
AKK_PR("posix-time",                    "adan-kayyamānum",           "𒅆𒂗𒁀")
AKK_PR("monotonic-time",                "adan-šutēšurum",            "𒉡𒂍")
AKK_PR("set-environment-variable!",     "šakān-simti-maškanim",      "𒈷𒅁𒉡")
AKK_PR("delete-environment-variable!",  "nasāḫ-simti-maškanim",      "𒊕𒌋𒄿")
AKK_PR("terminal?",                     "bāb-qabîm?",                "𒊻𒊕")
AKK_PR("implementation-name",           "zikru-epēšim",              "𒃲𒁹𒂍")
AKK_PR("implementation-version",        "minât-epēšim",              "𒌋𒂗")
AKK_PR("cpu-architecture",              "gattu-epēšim",              "𒍪𒇲")
AKK_PR("machine-name",                  "šum-epēšim",                "𒁀𒌝𒈷")
AKK_PR("os-name",                       "zikru-bītim",               "𒌝𒇲")
AKK_PR("os-version",                    "minât-bītim",               "𒌋𒊕𒉡")

/* ---- Procedures: (curry codesets) module (also covers SRFI 238) ---- */
/* zikrum: "designation, name" (reused from condition-type) for a symbol
 * <-> number codeset lookup table (errno, signal, http-status, ...). */
AKK_PR("codeset?",                      "zikrūtum?",                 "𒆜𒊻")
AKK_PR("codeset-symbols",               "zikrū-kalāma",              "𒈧𒈠𒀸")
AKK_PR("codeset-symbol",                "zikrum-ana-nikkassim",      "𒂗𒇲𒉡")
AKK_PR("codeset-number",                "nikkassum-ana-zikrim",      "𒌑𒍪")
AKK_PR("codeset-message",               "atmû-zikrim",               "𒆜𒄿𒅆")
