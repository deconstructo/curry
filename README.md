...
- [SRFI compatibility](docs/reference/srfi/index.md) — the 25 portable `(srfi sN name)` libraries, one page each
...
25 portable SRFI libraries under the `(srfi sN name)` naming convention — compatible with Guile, Chicken, and Chibi-Scheme. Full index: [`docs/reference/srfi/index.md`](docs/reference/srfi/index.md).
