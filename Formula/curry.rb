class Curry < Formula
  ...
  #   curl -L https://github.com/deconstructo/curry/archive/refs/tags/v0.8.12.tar.gz | shasum -a 256
  url "https://github.com/deconstructo/curry/archive/refs/tags/v0.8.12.tar.gz"
