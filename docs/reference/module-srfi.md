...
**Full documentation has moved to [`srfi/index.md`](srfi/index.md)**, which lists all 25 supported SRFIs with a link to each one's own reference page under [`docs/reference/srfi/`](srfi/).
