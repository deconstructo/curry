...
- [SRFI compatibility](docs/reference/srfi/index.md) — the 30 portable `(srfi sN name)` libraries, one page each
...
30 portable SRFI libraries under the `(srfi sN name)` naming convention — compatible with Guile, Chicken, and Chibi-Scheme. Full index: [`docs/reference/srfi/index.md`](docs/reference/srfi/index.md).
