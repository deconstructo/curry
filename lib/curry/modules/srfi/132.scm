(define-library (srfi 132)
  ...
  (export
    ...
    𒃲𒌋 šutēšur-nindabi-kayyamānum-ina 𒄀𒅆 nindabûm-šutēšurum? 𒇽𒈧𒅆 kaṣār-
    nindabîm 𒃲𒊻𒁹 kaṣār-nindabîm-ina 𒁹𒉡 šutēšur-ṣindim 𒆜𒈠𒍪 šutēšur-ṣindim-ina
    𒆜𒇲𒀸 šutēšur-ṣindi-kayyamānum 𒋻𒇽 šutēšur-ṣindi-kayyamānum-ina 𒈷𒂗𒌋 ṣindum-
    šutēšurum? 𒁀𒄿 kaṣār-ṣindim 𒅁𒌑𒋻 kaṣār-ṣindim-ina 𒇽𒅁𒈷)
  (begin
    (define-name-aliases
