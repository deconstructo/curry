class Curry < Formula
  ...
  #   curl -L https://github.com/deconstructo/curry/archive/refs/tags/v1.15.0.tar.gz | shasum -a 256
  url "https://github.com/deconstructo/curry/archive/refs/tags/v1.15.0.tar.gz"
