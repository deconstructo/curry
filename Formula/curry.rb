class Curry < Formula
  ...
  #   git tag v1.17.4 && git push origin v1.17.4
  #   curl -L https://github.com/deconstructo/curry/archive/refs/tags/v1.17.4.tar.gz | shasum -a 256
  url "https://github.com/deconstructo/curry/archive/refs/tags/v1.17.4.tar.gz"
  sha256 "PENDING"
  version "1.17.4"
